var wear_handout = {
    ...
    // whether we're currently processing a handout request
    ...
    setup: function() {
        ...
        if (this.input_box = jQuery('div#wear-handout-container input#user-id')) {
            this.done_button = jQuery('div#wear-handout-container input#mark-done');
    ...
    mark_wear_delivered: function() {
        ...
        if (this.last_user == '') {
            ...
            jQuery.ajax(this.ajax_uri, {
                type: 'post',
                data: {action: 'mark-received', user_id: that.last_user},
                timeout: 3000,
    ...
    undo_last_register: function() {
        ...
        jQuery.ajax(this.ajax_uri, {
            type: 'post',
            data: {action: 'undo-received', user_id: that.last_user},
            timeout: 3000,
            success: function(data, textStatus, jqXHR) {
