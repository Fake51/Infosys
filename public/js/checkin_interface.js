var checkin_interface = {
    ...
    setup: function() {
        ...
        if (this.input_box = jQuery('div#checkin-interface-container input#user-id')) {
            this.done_button = jQuery('div#checkin-interface-container input#mark-done');
    ...
    mark_checked_in: function() {
        if (this.undo_in_progress || this.checkin_in_progress) {
            this.soundWait();
            return;
        }
        ...
        if (this.last_user == '') {
            ...
            this.checkin_in_progress = true;

            jQuery.ajax(this.ajax_uri, {
                type: 'post',
                data: {action: 'mark-checkedin', user_id: that.last_user},
                timeout: 3000,
